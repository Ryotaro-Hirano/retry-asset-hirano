// 北京
  ...
  document.getElementById("chImg").onmouseOut=function() {
        document.getElementById("chImg").setAttribute("src","img/portfolio-hr/ch-bj.jpg");
  }
// ヴァチカン
  var preImg=new Image();
  ...
  document.getElementById("vcImg").onmouseOut=function() {
        document.getElementById("vcImg").setAttribute("src","img/portfolio-hr/vc-vachican.jpg");
  }
// ローマ
  var preImg=new Image();
  ...
  document.getElementById("itImg").onmouseOut=function() {
        document.getElementById("itImg").setAttribute("src","img/portfolio-hr/it-collseo.jpg");
  }
// マック
  var preImg=new Image();
  ...
  document.getElementById("nyImg").onmouseOut=function() {
        document.getElementById("nyImg").setAttribute("src","img/portfolio-hr/ny-apple.jpg");
  }
// センタラル
  var preImg=new Image();
  ...
  document.getElementById("nycImg").onmouseOut=function() {
        document.getElementById("nycImg").setAttribute("src","img/portfolio-hr/ny-central.jpg");
  }
// 図書館
  var preImg=new Image();
  ...
  document.getElementById("nylImg").onmouseOut=function() {
        document.getElementById("nylImg").setAttribute("src","img/portfolio-hr/ny-libray.jpg");
  }
